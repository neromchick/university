...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->levelPassed(); break;
        case 1: _t->gameWon((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->gameLost(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)()>(_a, &GameEngine::levelPassed, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(int )>(_a, &GameEngine::gameWon, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)()>(_a, &GameEngine::gameLost, 2))
            return;
    }
}
...
// SIGNAL 0
void GameEngine::levelPassed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameEngine::gameWon(int _t1)
{
